...
def do_visualize(core):
    ...
    from sgn_layers import extract_layers, combine_layers
    from sgn_utils import C, clear_stdin_buffer
...
from sgn_test import do_inference, do_batch_test, do_confusion, do_noise_test
from sgn_report import do_plot, do_export, _plot_accuracy, _plot_ascii, _plot_neurons, _plot_templates, _plot_comprehensive
