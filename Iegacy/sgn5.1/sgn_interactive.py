...
import sys
from sgn_commands import CommandRegistry, CommandContext
...
def menu(core, samples, step, max_step, test_samples=None, source=None):
    ...
    """
    from sgn_utils import C, hr, progress_bar, clear_stdin_buffer
...
# 控制面板
from sgn_panel import control_panel, _extension_menu, _advanced_menu, _show_category_menu

# 帮助手册
from sgn_help import do_help, do_why_accuracy

# 训练循环
from sgn_training import train_batch, header, out_step

# 黑箱验证
from sgn_blackbox import do_blackbox_verify
