...
> **测试源**: `simd/sgn_benchmark.cpp`（CMake target，收编自内部 EPYC 验证归档，计算逻辑逐行一致）
> **本文件**: 速度测试结果速览；完整方法/分析见 [docs/SGN_ArrowLake速度测试归档_2026_09_02.md](../../docs/SGN_ArrowLake速度测试归档_2026_09_02.md)
> **关联**: [EPYC 归档 2026-08-31](../../docs/SGN_EPYC速度测试归档_2026_08_31.md)、主报告 §八（内部档案）
...
| 编译 | Clang 22.1.8（<ToolchainRoot>\），CMake + Ninja Release，`-O3`，per-file ISA（同 simd/CMakeLists.txt） |
