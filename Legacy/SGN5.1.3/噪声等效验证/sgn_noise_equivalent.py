...
用法:
    ...
    from sgn_noise_equivalent import run_noise_equivalent  # 模块调用
"""
...
from sgn_config import CONFIG, PATTERNS
from sgn_input import DefaultCompositeNoise, GaussianNoise
